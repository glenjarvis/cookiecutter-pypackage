...
2. Clone the project::
    ...
    $ git clone {{ cookiecutter.github_project_uri }}.git
...
4. Activate the Virtual Enviroment. Every time you come back to work on this
   ...
   file:
       ...
       .. code-block:: bash
           ...
           function cd{{ cookiecutter.project_slug }} {
...
If this does happen, please email me at {{ cookiecutter.email }} with as much
...
*  Coursera course in collaboration with a UC College campus. If the current
   ...
   send me an email at {{ cookiecutter.email }} to remind me to place the
